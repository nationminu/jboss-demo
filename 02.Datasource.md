...
1. [JDBC 모듈 생성/로딩하기](./02.Datasource.md#1-jdbc-모둘-등록하기)
  1. GUI를 이용한 JDBC 모듈로딩
  2. CLI을 이용한 JDBC 모듈 로딩
  3. HTTP management API를 이용한 JDBC 모듈 로딩
  4. XML 을 이용한 JDBC 모듈 로딩
2. [Datasource 등록하기](./02.Datasource.md#2-datasource-등록하기)
  1. GUI 를 이용한 Datasoruce 등록
  2. CLI 를 이용한 Datasoruce 등록
  3. HTTP management API 를 이용한 Datasoruce 등록
  4. XML 을 이용한 Datasoruce 등록
